...
client_instance = AnthropicClient(api_key=api_key)
...
def get_best_answer(client_instance, question):
    ...
    """
    response = client_instance.client.messages.create(
...
def _check_semantic_equivalence(client_instance, a, b, question):
    ...
    response2 = client_instance.client.messages.create(
        model=client_instance.model,
        messages=[
